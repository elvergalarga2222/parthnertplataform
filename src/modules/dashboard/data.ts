...
// Currency-aware money formatter — implementation lives in src/lib/format.ts
// (single source since PR-4b); re-exported here for the existing dashboard
// imports until PR-11 unifies them.
